...
<div class="h-[80vh] grow sm:h-screen mobile-landscape:h-screen w-full px-[5%] self-center py-1 grid overflow-hidden items-center">
	
	<div class="flex flex-col sm:max-h-[85%] min-h-[50%]  gap-4 text-center align-middle">

		<div class="info-user screen border-black grow h-1/2 sm:h-full overflow-hidden flex shadow-lg shadow-black/50 bg-black/25 rounded-3xl">
