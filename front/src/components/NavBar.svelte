...
<!-- menu -->
			<li class="flex items-center">
				<div class="hidden md:flex items-center space-x-3 divide-x-2">
					<div class="hover:scale-110 transition-all flex items-center space-x-2">
					...
					<button class="hover:scale-110 transition-all pl-2"><Icon icon="bell" css="inline stroke-1 stroke-white fill-none" height="30" width="30" /></button>
					<button class="hover:scale-110 transition-all pl-2"><Icon icon="chat" css="inline " height="30" width="30" /></button>
					<button class="hover:scale-110 transition-all pl-2"><Icon icon="log" css="inline " height="30" width="30" /></button>
				</div>
				<div class="group flex-col items-center justify-center md:hidden transition-all duration-300 bg-black/50 rounded-full">
					...
					<div class="absolute p-2 space-y-2 z-20 scale-0 group-hover:scale-100 flex flex-col duration-300 origin-top bg-black/25 rounded-full">
						<button class="hover:scale-125 transition-all w-8 h-8 bg-cover rounded-full mx-auto"style="background-image: url( /{user?.image_url || 'image/default.png'} )"></button>
						<button class="hover:scale-125 transition-all"><Icon icon="chat" css="inline " height="30" width="30" /></button>
						<button class="hover:scale-125 transition-all"><Icon icon="friends" css="inline " height="30" width="30" /></button>
						<button class="hover:scale-125 transition-all"><Icon icon="log" css="inline " height="30" width="30" /></button>
					</div>
				</div>
			</li>
		</div>
