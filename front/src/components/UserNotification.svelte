...
<div class="flex bg-color5 rounded-xl items-center">
    ...
    <div class="relative">
		...
		<div class="absolute inline-flex items-center justify-center min-w-60 h-6 text-xs px-1 font-bold text-white bg-red-500 border-2 border-white rounded-full -top-1 -left-1 dark:border-gray-900">0</div>
