<script lang="ts">
	...
	export let league : string = "copper";
</script>
...
{:else if league === "gold"}
	<div class="flex items-center gap-1.5">
		<Icon icon="cup" color="#d4af37" height="20" width="20" />
		<div class="text-md gold-league bg-clip-text text-transparent">Gold League</div>
	</div>
{/if}