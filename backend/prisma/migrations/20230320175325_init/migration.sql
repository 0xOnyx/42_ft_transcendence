...
CREATE TABLE "Friend" (
    ...
    "accept_at" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "RoomUser" (
    ...
    "last_message_read_id" INTEGER NOT NULL,
    "count_read_messages" INTEGER NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "ActivityLog_user_id_key" ON "ActivityLog"("user_id");
...
-- AddForeignKey
ALTER TABLE "Rooms" ADD CONSTRAINT "Rooms_last_message_id_fkey" FOREIGN KEY ("last_message_id") REFERENCES "Messages"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "RoomUser" ADD CONSTRAINT "RoomUser_last_message_read_id_fkey" FOREIGN KEY ("last_message_read_id") REFERENCES "Messages"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
